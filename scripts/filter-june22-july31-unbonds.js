...
/**
 * Filter unstake data for June 22 - July 31, 2025
...
const outputFile = './unbonds_june22_july31_2025.json';

// Date range: June 22, 2025 00:00:00 to July 31, 2025 23:59:59
const startDate = new Date('2025-06-22T00:00:00.000Z');
const endDate = new Date('2025-07-31T23:59:59.999Z');

console.log('\n' + '='.repeat(80));
console.log('FILTERING UNSTAKE DATA: JUNE 22 - JULY 31, 2025');
...
try {
    ...
    console.log(`Unbonds in June 22 - July 31, 2025: ${filteredUnbonds.length}\n`);
    ...
    console.log('='.repeat(80));
    console.log('TOP 10 VALIDATORS BY TOTAL UNSTAKE AMOUNT (JUNE 22 - JULY 31, 2025)');
    console.log('='.repeat(80));
    ...
    console.log('='.repeat(80));
    console.log('TOP 10 LARGEST UNBONDS (JUNE 22 - JULY 31, 2025)');
    console.log('='.repeat(80));
